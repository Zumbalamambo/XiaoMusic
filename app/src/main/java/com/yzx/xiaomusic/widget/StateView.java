...
public class StateView extends View {
    ...
    private static final String TAG = "yglStateView";
    ...
    public static StateView inject(@NonNull ViewGroup parent, boolean hasActionBar) {
        ...
        if (parent instanceof LinearLayout ||
            ...
            if (viewParent == null) {
                ...
                Log.i(TAG, "inject: have no parent");
        ...
        if (screenHeight > 0) {
            ...
            ViewGroup.LayoutParams params = new ViewGroup.LayoutParams(
                    ...
                    hasActionBar ? (int) (screenHeight - stateView.getActionBarHeight() - DensityUtils.dip2px(25)) : screenHeight);
    ...
    public void setTopMargin() {
        ...
        layoutParams.topMargin = (int) (getActionBarHeight() + DensityUtils.dip2px(25));
    }
