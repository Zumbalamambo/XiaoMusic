...
public final class PreferenceUtil {
  ...
  public static String getString(String key, String defValue) {
    ...
    return PreferenceManager.getDefaultSharedPreferences(MusicApplication.getApplication())
  ...
  private static void putFloat(String key, float value) {
    ...
    SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(
            MusicApplication.getApplication());
  ...
  public static void putStringProcess(String key, String value) {
    ...
    SharedPreferences sharedPreferences = MusicApplication.getApplication()
